Name="Jamuna Balamurugan"
console.log('welcome to Java Script programming '+ Name+' !!!!')
fruits=['Apple','Orange','Kiwi','Datefruit'];
//fruits.pop();
console.log(fruits.sort());//apple.datefruit,kiwi,orange
fruits.push('Woodapple');//apple.datefruit,kiwi,orange,woodapple
fruits.reverse();
